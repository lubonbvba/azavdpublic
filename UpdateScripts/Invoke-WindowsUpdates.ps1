# https://github.com/Azure/FederalAVD/blob/main/.common/scripts/Invoke-WindowsUpdate.ps1
# Description: This script uses the Windows Update Agent (WUA) API to search for, download, and install Windows Updates.
