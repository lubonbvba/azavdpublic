...
try {
        ...
        if((Get-ComputerInfo).WindowsInstallationType -eq "Client"){
                ...
                If((Get-ComputerInfo).CsName -like "C0032*") {
                        Write-Log -Message "Run VDOT without RemoveLegacyIE" -Category 'INFO' 
                        ...
                        Write-Log -Message "Run VDOT" -Category 'INFO' 
        ...
        #  Restart VM
        ##############################################################
        Write-Log -Message 'Set-SessionHostConfigurationv2 finished, restarting' -Category 'INFO'
        Write-Log -Message 'Lubon session host script' -Category 'INFO'
